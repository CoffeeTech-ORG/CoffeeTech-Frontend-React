...
const translations = {
  en: {
    ...
    'profile.account.saveError': 'Could not update your account.',
  ...
  es: {
    ...
    'profile.email.invalid': 'Ingresa un correo válido.',
    'profile.email.taken': 'Ese correo ya está en uso.',
    'profile.account.saveError': 'No se pudo actualizar tu cuenta.',
